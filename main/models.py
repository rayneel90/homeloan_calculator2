...
class Query(models.Model):
    ...
    ltv = models.FloatField("LTV", blank=True, null=True)
    roi = models.FloatField("ROI", blank=True, null=True)
    ...
    months_to_possession = models.IntegerField("time to possess", blank=True, null=True)
    monthly_rent_earning = models.IntegerField("Monthly Rent",blank=True, null=True)
    annual_maintenance = models.IntegerField("Annual Maint.", blank=True, null=True)
    ...
    self_pf_contri = models.IntegerField("PF Self Contrib",blank=True, null=True)
